...
pyramidfolder = '/misc/data18/rothzn/nsd/stimuli/pyramid_noBackground_v2';
interpImgSize = 714;
backgroundSize = 1024;
imgScaling = 0.5;
numOrientations = 8;
...
if reloadData
    ...
    save([nsdFolder 'imgPyrStats_noBg_v2_' num2str(nimgs) 'imgs.mat'],"allModelOri",'nimgs','numLevels','numOrientations');
    toc
else
    load([nsdFolder 'imgPyrStats_noBg_v2_' num2str(nimgs) 'imgs.mat'],"allModelOri",'nimgs','numLevels','numOrientations');
end
